...
var (
	...
	file_nexus_v1_options_proto_rawDescData []byte
)

func file_nexus_v1_options_proto_rawDescGZIP() []byte {
	file_nexus_v1_options_proto_rawDescOnce.Do(func() {
		file_nexus_v1_options_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_nexus_v1_options_proto_rawDesc), len(file_nexus_v1_options_proto_rawDesc)))
	})
...
func file_nexus_v1_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_nexus_v1_options_proto_rawDesc), len(file_nexus_v1_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 2,
			NumServices:   0,
